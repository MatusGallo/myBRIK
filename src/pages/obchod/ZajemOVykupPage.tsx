...
import ZajemOVykupPanel from '../../components/obchod/ZajemOVykupPanel'
...
const cols = [
  ...
  { key: 'ccId', label: 'CC ID', width: 80 },
  { key: 'cena', label: 'Cena', width: 130, align: 'right' as const },
  { key: 'typNemovitosti', label: 'Typ nemovitosti', width: 150 },
...
export default function ZajemOVykupPage() {
  ...
  return (
    <>
      <ListPageShell
        title="Zájem o výkup"
        actions={[{ label: 'Vytvořit zájem o výkup', variant: 'primary', icon: 'plus', onClick: () => setPanelOpen(true) }]}
        filterBar={
          <PageFilterBar
      ...
      {panelOpen && <ZajemOVykupPanel onClose={() => setPanelOpen(false)} />}
    </>
  )
}
